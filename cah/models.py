...
class CahDeck(models.Model):
    party = models.ForeignKey(Party, related_name='cah_deck', on_delete=models.CASCADE)
...
class WhiteCahCard(models.Model):
    ...
    deck = models.ForeignKey(CahDeck, related_name='white_cards', on_delete=models.CASCADE)
...
class BlackCahCard(models.Model):
    ...
    card_type = models.CharField(max_length=255, unique=True)
    card_text = models.CharField(max_length=255, unique=True)
    deck = models.ForeignKey(CahDeck, related_name='black_cards', on_delete=models.CASCADE)
